...
export default function SignalsList(props: Props) {
  ...
  const refreshAlertsList = async (ticker: string, createdAtFrom: string): Promise<AlertsModel[] | undefined> => {
  ...
  return (
    <Card className="mb-4" style={{height: '100%'}}>
      <div className="justify-content-between">
        <div>
          <h4 className="pt-2" style={{paddingLeft: '1rem', marginBottom: '0rem'}}>Signals</h4>
        </div>
      </div>
      <Card.Body>
