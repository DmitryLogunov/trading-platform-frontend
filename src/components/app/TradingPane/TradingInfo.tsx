            ...
            <header className="header sticky-top mb-2 px-sm-2 border">
                <div className="row">
                    ...
                    <div className="col-sm-8 align-items-stretch" style={{marginLeft: "-1.5rem"}}>
                        <Container fluid className="d-flex align-items-center">
                            <div className="justify-content-between m-lg-1">
                                <div className="small text-black-50"><span style={{fontWeight: "bold"}}>ID:</span> {tradingData.id}</div>
                            </div>
                            <span style={{display: "block", width: "5px", marginRight: "5px", height: "12px", borderRight: "1px solid gray"}}></span>
                            <div className="justify-content-between m-lg-1">
                                <div className="small text-black-50"><span style={{fontWeight: "bold"}}>Started:</span> {tradingData.startedAt}</div>
                            </div>
                            { tradingData.closedAt != null ?
                              <div className="justify-content-between m-lg-1">
                                  { tradingData.closedAt !== '' ?
                                    <div className="small text-black-50">
                                        <div style={{paddingLeft: "5px", height: "12px", borderLeft: "1px solid gray", display: "inline"}}>
                                            <span style={{fontWeight: "bold"}}>Closed:</span>
                                        </div> {tradingData.closedAt}
                                    </div> :
                                    ''
                                  }
                              </div> :
                    ...
                    <div className="col-sm-3 align-items-stretch">
                        <button type="button" className="btn btn-primary m-lg-2"
                                style={{position: "absolute", top: "0.1rem", right: "4rem"}}
                                data-toggle="tooltip" data-placement="top" title="Refresh trading info"
                                onClick={refreshTradingData}
                        >
                            <img src="/assets/img/arrow-clockwise.svg"/>
                        </button>
                        { tradingData.closedAt == null ?
                            <button type="button" className="btn btn-secondary m-lg-2"
                                    style={{position: "absolute", top: "0.1rem", right: "1rem"}}
                                    data-toggle="tooltip" data-placement="top" title="Stop trading"
                            ...
                            <button type="button" className="btn btn-secondary m-lg-2"
                                    style={{position: "absolute", top: "0.1rem", right: "1rem"}}
                                    data-toggle="tooltip" data-placement="top" title="Restart trading"
