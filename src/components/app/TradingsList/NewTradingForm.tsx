                        ...
                        <Container fluid className="d-flex align-items-center">
                            <div className="justify-content-between m-lg-1" style={{width: "300px"}}>
                                <div className="small text-black-50 d-flex">
                                    ...
                                    <input type="text" className="form-control m-lg-2" defaultValue="USDT" id="baseCurrency" style={{width: "80px"}}/>
                                </div>
                            </div>
                            <div className="justify-content-between m-lg-1"  style={{width: "300px"}}>
                                <div className="small text-black-50 d-flex">
                            ...
                            <div className="justify-content-between m-lg-1" style={{width: "500px"}}>
                                <div className="small text-black-50 d-flex">
                                    ...
                                    <input type="text" className="form-control m-lg-2" defaultValue={currentISODatetime} id="startedAt" style={{width: "180px"}}/>
                                </div>
                            </div>
                            <div className="justify-content-between m-lg-1" style={{marginLeft: "-100px !important"}}>
                                <div className="small text-black-50 d-flex">
                                    ...
                                    <input type="text" className="form-control  w-25 m-lg-2" defaultValue="10 000" id="baseDepositInBaseCurrency"/>
                                </div>
                            </div>
                            <div className="justify-content-between m-lg-1" style={{paddingRight: "100px"}}></div>
                        </Container>
                    </div>
                    <div className="col-sm-2 align-items-stretch">
                        <button type="submit" className="btn btn-primary m-lg-2"
                                style={{position: "absolute", top: "0.1rem", right: "4rem"}}
                                data-toggle="tooltip" data-placement="top" title="Create new trading"
                        >
                            Create new trading pane
                        </button>
                        <button type="button" className="btn btn-link m-lg-2"
                                style={{position: "absolute", top: "-1rem", right: "-1rem"}}
                                data-toggle="tooltip" data-placement="top" title="Hide new trading pane form"
                                onClick={callback}
                        >
